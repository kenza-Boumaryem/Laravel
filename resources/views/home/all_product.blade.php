...
<div style="text-align:center; padding-bottom:30px;">
   <h1 style="font-size:30px;padding-yop:20px;text-align:center;padding-bottom:20px;">Comments</h1>
<form action="{{url('add_comment')}}" method="POST">
   @csrf
   <textarea style="height:150px;width:600px;" name="comment"  cols="30" rows="10" placeholder="Comment something here"></textarea>
  <br>
